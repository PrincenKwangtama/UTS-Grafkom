...
namespace Tes
{
    internal class Asset3D
    {
        ...
        public Asset3D(List<Vector3> vertices, List<uint> indices, float r,float g,float b,float alpha)
        {
            _vertices = vertices;
            _indices = indices;
            _color[0] = r;
        ...
        public void Scale(float scale, Asset3D temp)
        {
        ...
        public void createCrescent(float x,float y,float z,float length,float heigth,float crescWide,bool faceUp)
        {
            setX(x);
            setY(y);
            setZ(z);
        ...
        public void createCurveBezier(List<Vector3> v)
        {
            _vertices = v;
